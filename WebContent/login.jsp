...
<body
	style="background-image: url('${pageContext.servletContext.contextPath }/admin_files/11.jpg');margin-top:0px;background-repeat: round;"">
				...
				<table style="width: 100%">
					<tr>
						<td align="left"><img
							...
							alt="Logo"></td>
							<td align="center" style="font-weight: bold;color: gray;">卡劵优惠系统</td>
						<td align="right"><img
							src="${pageContext.servletContext.contextPath }/admin_files/logo_left.png"
							alt="Logo"></td>
					</tr>
