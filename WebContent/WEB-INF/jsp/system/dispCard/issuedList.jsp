...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/system/dispCard/issuedList.js"></script>
...
$('#endDate').datetimepicker({
	...
	<div class="m-b-md"> 
		<form class="form-inline" role="form" id="searchForm" name="searchForm">
			...
			<a href="javascript:grid.exportData('/cardReport/exportIssuedList.sxml')" class="btn btn-info" id="export">导出excel</a>
		</form>
	</div>
